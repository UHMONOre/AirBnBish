...
CREATE TABLE `bookingstatus` (
  ...
  KEY `HomeId` (`HomeId`),
  CONSTRAINT `bookingstatus_ibfk_1` FOREIGN KEY (`CustomerId`) REFERENCES `customers` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `bookingstatus_ibfk_2` FOREIGN KEY (`HomeId`) REFERENCES `homes` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `customers` VALUES (1,'mporasalex@gmail.com','123','uhmono'),(4,'mporasalex','123','uhmonore'),(5,'test1','123','test1');
...
-- Dump completed on 2025-11-14 13:27:10
